...
from phenixio import rest
from phenixio.configuration import Configuration
from phenixio.exceptions import ApiTypeError, ApiValueError, ApiException
from phenixio.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AuthTokensApi()
        api_instance.auth_tokens_create  # this is an instance of the class Endpoint
        api_instance.auth_tokens_create()  # this invokes api_instance.auth_tokens_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.auth_tokens_create.callable or self.callable in this class
