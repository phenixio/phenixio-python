...
class SubscriptionPlanOutput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'collection_method': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, account, *args, **kwargs):  # noqa: E501
        """SubscriptionPlanOutput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            interval (str): Set a subscription payment interval.. [optional] if omitted the server will use the default value of "month"  # noqa: E501
            price (str): Set a price for your subscription.. [optional]  # noqa: E501
            currency (str): [optional] if omitted the server will use the default value of "usd"  # noqa: E501
            collection_method (str): Collect payments by sending Lightning payment request to customer email.. [optional] if omitted the server will use the default value of "send_invoice"  # noqa: E501
            webhook_url (str): Set the webhook endpoint to get notified on your application backend.. [optional]  # noqa: E501
            application_url (str): Application associated with this subscription plan. Customers are redirected after successful payments.. [optional]  # noqa: E501
            name (str): The name of your subscription. It will appear in the email we send to your customers.. [optional]  # noqa: E501
            description (str): Short description of your subscription product/service. It will appear in the email we send to your customers.. [optional]  # noqa: E501
            grace_period (int): Set how many days a subscription gets canceled for over due payments.. [optional]  # noqa: E501
        """
