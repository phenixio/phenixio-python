...
class PaidChargesOutput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account, amount, value, description, payment_request, lninvoice, settleevent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account, amount, value, description, payment_request, lninvoice, settleevent, *args, **kwargs):  # noqa: E501
        """PaidChargesOutput - a model defined in OpenAPI
