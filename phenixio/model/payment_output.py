...
class PaymentOutput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account, amount, description, payment_request, lninvoice, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account, amount, description, payment_request, lninvoice, *args, **kwargs):  # noqa: E501
        """PaymentOutput - a model defined in OpenAPI
