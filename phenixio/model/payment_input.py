...
class PaymentInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, value, description, *args, **kwargs):  # noqa: E501
        """PaymentInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, value, description, *args, **kwargs):  # noqa: E501
        """PaymentInput - a model defined in OpenAPI
