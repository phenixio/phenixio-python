...
class WithdrawalRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, amount, addr, *args, **kwargs):  # noqa: E501
        """WithdrawalRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, amount, addr, *args, **kwargs):  # noqa: E501
        """WithdrawalRequest - a model defined in OpenAPI
