...
class LightningInvoiceOutput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, payment_request, expiry, r_hash, *args, **kwargs):  # noqa: E501
        """LightningInvoiceOutput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            network (str): Lightning Network version (testnet/mainnet). [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, payment_request, expiry, r_hash, *args, **kwargs):  # noqa: E501
        """LightningInvoiceOutput - a model defined in OpenAPI
